...
export function Footer() {
  ...
  const resourceLinks = [
    { label: "GitHub Codebase", path: "https://github.com/hmaxEdu/Masar-ai", isExternal: true },
    { label: "Developer Profile", path: "https://github.com/hmaxEdu", isExternal: true },
    { label: "Contact Developer", path: "https://www.linkedin.com/in/albaraa-qajjah-1b5030271", isExternal: true },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 mb-10">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="flex items-center gap-4 pt-1">
              <a href="https://github.com/hmaxEdu/Masar-ai" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <Github className="w-4 h-4 text-muted-foreground/60 hover:text-foreground transition-colors" />
              </a>
              <a href="#" aria-label="X">
                <XIcon />
              </a>
              <a href="https://www.linkedin.com/in/albaraa-qajjah-1b5030271" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <LinkedInIcon />
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-2 col-span-1">
            ...
            <ul className="space-y-2">
              {productLinks.map((link) => (
                <li key={link.label}>
                  <Link to={link.path} className="text-xs text-muted-foreground/85 hover:text-foreground transition-colors font-medium">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="md:col-span-2 col-span-1">
            <h4 className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60 mb-3">Solutions</h4>
            <ul className="space-y-2">
          ...
          <div className="md:col-span-3 col-span-1">
            <h4 className="font-bold text-[10px] uppercase tracking-wider text-muted-foreground/60 mb-3">Resources</h4>
            <ul className="space-y-2">
